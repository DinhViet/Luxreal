...
import com.truemoney.framework.persistence.model.interfaces.IdEntity;

@MappedSuperclass
public abstract class IdEntry<ID extends Serializable> extends UpdatableDbEntry implements IdEntity<ID>, Serializable {
