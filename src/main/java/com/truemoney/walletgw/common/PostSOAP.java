...
/**
 * 
 * This is a sample application that demonstrates how to use the Jakarta HttpClient API.
 * 
...
public class PostSOAP {
   ...
   * 
   * @param args command line arguments Argument 0 is a URL to a web server Argument 1 is the SOAP
   *        Action Argument 2 is a local filename
   * 
   */
  public static void main(String[] args) throws Exception {
    if (args.length != 3) {
      System.out
          .println("Usage: java -classpath <classpath> [-Dorg.apache.commons.logging.simplelog.defaultlog=<loglevel>] PostSOAP <url> <soapaction> <filename>]");
      System.out
          .println("<classpath> - must contain the commons-httpclient.jar and commons-logging.jar");
